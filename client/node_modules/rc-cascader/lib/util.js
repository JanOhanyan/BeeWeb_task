...
function convertOptions(options, _ref) {
  ...
  function injectValue(list) {
    ...
    return (list || []).map(function (option) {
      ...
      var cloneOption = (0, _objectSpread3.default)((0, _objectSpread3.default)({}, option), {}, (_objectSpread2 = {}, (0, _defineProperty2.default)(_objectSpread2, fieldValue, newValue), (0, _defineProperty2.default)(_objectSpread2, "node", option), _objectSpread2));
